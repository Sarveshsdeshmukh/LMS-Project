...
if(isset($_POST['submit'])){
   ...
   if($thumb_size > 2000000){
      ...
      $add_content_query = "INSERT INTO content(id, tutor_id, playlist_id, title, description, video, thumb, status) VALUES($1, $2, $3, $4, $5, $6, $7, $8)";
      $add_content_result = pg_query_params($conn, $add_content_query, array($id, $tutor_id, $playlist, $title, $description, $rename_video, $rename_thumb, $status));
      if($add_content_result){
         move_uploaded_file($thumb_tmp_name, $thumb_folder);
         move_uploaded_file($video_tmp_name, $video_folder);
         $message[] = 'new course uploaded!';
      }else{
         $message[] = 'Error occurred while uploading course!';
      }
   }
